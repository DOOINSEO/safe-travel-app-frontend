...
export default function PostItem({post, handleLikeToggle}) {
    ...
    return (<Link to={`/board/${post.postId}`} className="block transition-colors hover:bg-gray-50">
            <div className="border-t border-gray-200 bg-white p-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        {isDropdownOpen && (<div
                                className="absolute right-0 top-full z-10 mt-2 w-40 rounded-md border bg-white shadow-lg">
                ...
                {post.images && post.images.length > 0 && (<div
                        className={`grid gap-2 ${post.images.length >= 3 ? 'grid-cols-3' : `grid-cols-${post.images.length}`}`}>
